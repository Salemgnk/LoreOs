    ...
    <main className="flex min-h-screen items-center justify-center p-8">
      <div className="w-full max-w-md bg-[var(--bg-card)] rounded-xl p-8">
        ...
        <button
          ...
          className="relative z-10 w-full flex items-center justify-center gap-3 py-3 bg-white text-gray-800 rounded-lg font-medium hover:bg-gray-100 transition-colors mb-4 cursor-pointer"
        >
